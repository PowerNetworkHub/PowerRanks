...
public class CmdAddinheritance extends PowerCommand {


    public CmdAddinheritance(PowerRanks plugin, String command_name, COMMANDEXECUTOR ce) {
    ...
    public boolean onCommand(CommandSender sender, String commandLabel, String commandName, String[] args) {
        if (args.length == 2) {
            ...
            if (rank != null) {
                rank.addInheritance(inheritance);
