...
public class CmdAddusertag extends PowerCommand {

    public CmdAddusertag(PowerRanks plugin, String command_name, COMMANDEXECUTOR ce) {
    ...
    public boolean onCommand(CommandSender sender, String commandLabel, String commandName, String[] args) {
        if (args.length == 1) {
                ...
                final boolean result = plugin.getUsertagManager().addUsertag(playername, tag);
