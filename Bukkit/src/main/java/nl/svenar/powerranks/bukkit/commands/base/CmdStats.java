...
public class CmdStats extends PowerBaseCommand {
    ...
    private void messageStats(CommandSender sender) {
		...
		sender.sendMessage(PowerColor.ChatColor.DARK_AQUA + "--------" + PowerColor.ChatColor.DARK_BLUE + PowerRanks.pdf.getName()
				+ PowerColor.ChatColor.DARK_AQUA + "--------");
		sender.sendMessage(PowerColor.ChatColor.GREEN + "Server version: " + PowerColor.ChatColor.DARK_GREEN + Bukkit.getVersion() + " | "
				+ Bukkit.getServer().getBukkitVersion());
		sender.sendMessage(
				PowerColor.ChatColor.GREEN + "Java version: " + PowerColor.ChatColor.DARK_GREEN + System.getProperty("java.version"));
		...
		sender.sendMessage(
				PowerColor.ChatColor.GREEN + "PowerRanks Version: " + PowerColor.ChatColor.DARK_GREEN + PowerRanks.pdf.getVersion());
		sender.sendMessage(PowerColor.ChatColor.GREEN + "Registered ranks: " + PowerColor.ChatColor.DARK_GREEN + PRCache.getRanks().size());
		sender.sendMessage(
				PowerColor.ChatColor.GREEN + "Registered players: " + PowerColor.ChatColor.DARK_GREEN + PRCache.getPlayers().size());
		sender.sendMessage(PowerColor.ChatColor.GREEN + "Registered addons: " + PowerColor.ChatColor.DARK_GREEN + addonCount);
		...
		sender.sendMessage(PowerColor.ChatColor.GREEN + "RGB colors: "
				+ (hex_color_supported ? PowerColor.ChatColor.DARK_GREEN + "" : PowerColor.ChatColor.DARK_RED + "un") + "supported");
		sender.sendMessage(PowerColor.ChatColor.GREEN + "Bungeecord: "
				+ (PowerRanks.getInstance().getBungeecordManager().isReady() ? PowerColor.ChatColor.DARK_GREEN + "enabled"
		...
		sender.sendMessage(PowerColor.ChatColor.GREEN + "Plugins (" + plugins.length + "): " + PowerColor.ChatColor.DARK_GREEN + pluginNames);
		sender.sendMessage(PowerColor.ChatColor.DARK_AQUA + "--------------------------");
	}
}