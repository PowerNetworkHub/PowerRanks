...
public class Updater {
	...
	private boolean versionCheck() {
		...
		if (this.type != UpdateType.NO_VERSION_CHECK) {
			final String localVersion = this.plugin.getDescription().getVersion().replaceAll("[a-zA-Z ]", "");
	...
	public boolean shouldUpdate(String localVersion, String remoteVersion) {
		...
		return VersionUtils.calculateVersionFromString(remoteVersion) > VersionUtils.calculateVersionFromString(localVersion);
	}
