...
public class CommandRankPermissionsWorld extends PowerCommand {

    public CommandRankPermissionsWorld(PowerRanks plugin, COMMAND_EXECUTOR ce, boolean showInHelp) {
    ...
    public String getDescription() {
        return "Base rank permission worlds command";
    }
