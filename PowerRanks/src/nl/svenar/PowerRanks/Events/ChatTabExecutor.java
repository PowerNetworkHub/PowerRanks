...
//			Player p = (Player) sender;
			...
			if (args.length == 2) {
				...
				if (args[0].equalsIgnoreCase("setrank") || args[0].equalsIgnoreCase("promote") || args[0].equalsIgnoreCase("demote") || args[0].equalsIgnoreCase("checkrank") || args[0].equalsIgnoreCase("addsubrank")
