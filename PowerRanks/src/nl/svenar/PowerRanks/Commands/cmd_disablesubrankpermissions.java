...
public class cmd_disablesubrankpermissions extends PowerCommand {

	private Users users;

	public cmd_disablesubrankpermissions(PowerRanks plugin, String command_name, COMMAND_EXECUTOR ce) {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
		if (sender.hasPermission("powerranks.cmd.disablesubrankpermissions")) {
			if (args.length == 2) {
				...
				Messages.messageCommandUsageDisablesubrankpermissions(sender);
			}
		} else {
