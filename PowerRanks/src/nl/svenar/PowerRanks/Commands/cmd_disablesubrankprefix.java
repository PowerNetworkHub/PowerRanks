...
public class cmd_disablesubrankprefix extends PowerCommand {

	private Users users;

	public cmd_disablesubrankprefix(PowerRanks plugin, String command_name, COMMAND_EXECUTOR ce) {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
		if (sender.hasPermission("powerranks.cmd.disablesubrankprefix")) {
			if (args.length == 2) {
				...
				Messages.messageCommandUsageDisablesubrankprefix(sender);
			}
		} else {
