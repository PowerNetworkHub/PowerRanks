...
public class cmd_disablesubranksuffix extends PowerCommand {

	private Users users;

	public cmd_disablesubranksuffix(PowerRanks plugin, String command_name, COMMAND_EXECUTOR ce) {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
		if (sender.hasPermission("powerranks.cmd.disablesubranksuffix")) {
			if (args.length == 2) {
				...
				Messages.messageCommandUsageDisablesubranksuffix(sender);
			}
		} else {
