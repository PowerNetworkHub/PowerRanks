...
public class cmd_enablesubrankpermissions extends PowerCommand {

	private Users users;

	public cmd_enablesubrankpermissions(PowerRanks plugin, String command_name, COMMAND_EXECUTOR ce) {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
		if (sender.hasPermission("powerranks.cmd.enablesubrankpermissions")) {
			if (args.length == 2) {
				...
				Messages.messageCommandUsageEnablesubrankpermissions(sender);
			}
		} else {
