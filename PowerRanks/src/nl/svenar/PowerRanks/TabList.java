...
public class TabList {
	...
	private static final HashMap<UUID, TabList> lookUpTable = new HashMap<>();
	...
	public static TabList getPlayerList(Player player) {
		if (!lookUpTable.containsKey(player.getUniqueId()))
			return new TabList(player, SIZE_TWO);
...
class Skin implements ConfigurationSerializable {
	...
	public static void getSkin(String username, SkinCallBack callBack) {
		...
		if (newcall) {
			...
			}.runTaskAsynchronously(TabList.plugin);
		}
	}
