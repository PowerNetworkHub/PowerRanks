...
public final class PermissibleInjector {
    ...
    public static boolean isInjected(Player p) {
        try {
            ...
            return permissible instanceof PermissibleBase;
        } catch (Exception e) {
            e.printStackTrace();
        }
        return false;
    ...
    public static Permissible uninject(Player p) {
        try {
            ...
            if (permissible instanceof PowerPermissableBase) {
                HUMAN_ENTITY_PERMISSIBLE_FIELD.set(p, ((PowerPermissableBase) permissible).getOldPermissible());
                return (PowerPermissableBase) permissible;
            }
