...
public class GUIPage {
	...
	public static enum GUI_PAGE_ID {
		RANKUP(0, "rankup"), MAIN(1, "main"), CMD_SETRANK_INPUT_PLAYER(2, "select player"), CMD_SETRANK_INPUT_RANK(3, "select rank"), CMD_CHECKRANK_INPUT_PLAYER(4, "select player"), CMD_PROMOTE_INPUT_PLAYER(5, "select player"),
	...
	Inventory setupGUI(GUI_PAGE_ID pageID) {
		...
		if (pageID.getID() == GUI_PAGE_ID.MAIN.getID()) {
			new_gui.setItem(0, createGuiItem(Material.DISPENSER, ChatColor.GREEN + "Set a players rank", ChatColor.BLACK + "cmd:setrank", ChatColor.RESET + "/pr set <player> <rank>"));
			new_gui.setItem(1, createGuiItem(Material.REDSTONE, ChatColor.GREEN + "Check a players rank", ChatColor.BLACK + "cmd:checkrank", ChatColor.RESET + "/pr check <player>"));
			new_gui.setItem(2, createGuiItem(Material.EMERALD, ChatColor.GREEN + "Promote a player", ChatColor.BLACK + "cmd:promote", ChatColor.RESET + "/pr promote <player>"));
			...
			new_gui.setItem(9, createGuiItem(Material.IRON_BLOCK, ChatColor.GREEN + "Remove a inheritance from a rank", ChatColor.BLACK + "cmd:delinheritance", ChatColor.RESET + "/pr delinheritance <rank> <inheritance>"));
			new_gui.setItem(10, createGuiItem(Material.FURNACE, ChatColor.GREEN + "Add a buyable rank to a rank", ChatColor.BLACK + "cmd:addbuyable", ChatColor.RESET + "/pr addbuyablerank <rank> <buyable_rank>"));
			new_gui.setItem(11, createGuiItem(Material.OBSIDIAN, ChatColor.GREEN + "Remove a buyable rank from a rank", ChatColor.BLACK + "cmd:delbuyable", ChatColor.RESET + "/pr delbuyablerank <rank> <buyable_rank>"));

//			inventoryGUIMain.addItem(createGuiItem(Material.STONE, "/pr setdefaultrank", "Set the default rank for new players."));
//			inventoryGUIMain.addItem(createGuiItem(Material.YELLOW_FLOWER, "/pr addinheritance", "Add a inheritance to a rank."));
//			inventoryGUIMain.addItem(createGuiItem(Material.RED_ROSE, "/pr delinheritance", "Remove a inheritance from a rank."));
		}

		if (pageID.getID() == GUI_PAGE_ID.CMD_SETRANK_INPUT_PLAYER.getID() || pageID.getID() == GUI_PAGE_ID.CMD_CHECKRANK_INPUT_PLAYER.getID() || pageID.getID() == GUI_PAGE_ID.CMD_PROMOTE_INPUT_PLAYER.getID()
		...
		if (pageID.getID() == GUI_PAGE_ID.CMD_ADDINHERITANCE_INPUT_RANK2.getID() || pageID.getID() == GUI_PAGE_ID.CMD_ADDBUYABLERANK_INPUT_RANK2.getID()) {
			Object[] ranks = users.getGroups().toArray();
			int num_rank_on_page = new_gui.getSize() - 9;
		...
		if (pageID.getID() == GUI_PAGE_ID.CMD_SETCHATCOLOR_INPUT_COLOR.getID() || pageID.getID() == GUI_PAGE_ID.CMD_SETNAMECOLOR_INPUT_COLOR.getID()) {
			try {
				new_gui.setItem(0, BannerItem.addPattern(BannerItem.createEmpty("Black", "&0"), DyeColor.BLACK, PatternType.BASE));
				new_gui.setItem(1, BannerItem.addPattern(BannerItem.createEmpty("Dark Blue", "&1"), DyeColor.BLUE, PatternType.BASE));
				new_gui.setItem(2, BannerItem.addPattern(BannerItem.createEmpty("Dark Green", "&2"), DyeColor.GREEN, PatternType.BASE));
				new_gui.setItem(3, BannerItem.addPattern(BannerItem.addPattern(BannerItem.createEmpty("Dark Turquoise", "&3"), DyeColor.CYAN, PatternType.BASE), DyeColor.BLACK, PatternType.GRADIENT));
				new_gui.setItem(4, BannerItem.addPattern(BannerItem.addPattern(BannerItem.createEmpty("Dark Red", "&4"), DyeColor.RED, PatternType.BASE), DyeColor.BLACK, PatternType.GRADIENT));
				new_gui.setItem(5, BannerItem.addPattern(BannerItem.createEmpty("Purple", "&5"), DyeColor.PURPLE, PatternType.BASE));
				new_gui.setItem(6, BannerItem.addPattern(BannerItem.createEmpty("Orange", "&6"), DyeColor.ORANGE, PatternType.BASE));
				new_gui.setItem(7, BannerItem.addPattern(BannerItem.createEmpty("Light Gray", "&7"), DyeColor.LIGHT_GRAY, PatternType.BASE));
				new_gui.setItem(8, BannerItem.addPattern(BannerItem.createEmpty("Dark Gray", "&8"), DyeColor.GRAY, PatternType.BASE));
				new_gui.setItem(9, BannerItem.addPattern(BannerItem.addPattern(BannerItem.createEmpty("Light Blue", "&9"), DyeColor.LIGHT_BLUE, PatternType.BASE), DyeColor.BLUE, PatternType.GRADIENT));
				new_gui.setItem(10, BannerItem.addPattern(BannerItem.createEmpty("Light Green", "&a"), DyeColor.LIME, PatternType.BASE));
				new_gui.setItem(11, BannerItem.addPattern(BannerItem.createEmpty("Light Turquoise", "&b"), DyeColor.LIGHT_BLUE, PatternType.BASE));
				new_gui.setItem(12, BannerItem.addPattern(BannerItem.createEmpty("Red", "&c"), DyeColor.RED, PatternType.BASE));
				new_gui.setItem(13, BannerItem.addPattern(BannerItem.createEmpty("Magenta", "&d"), DyeColor.MAGENTA, PatternType.BASE));
				new_gui.setItem(14, BannerItem.addPattern(BannerItem.createEmpty("Yellow", "&e"), DyeColor.YELLOW, PatternType.BASE));
				new_gui.setItem(15, BannerItem.addPattern(BannerItem.createEmpty("White", "&f"), DyeColor.WHITE, PatternType.BASE));
			} catch (NoSuchFieldError e) {
				new_gui.setItem(0, createGuiItem(Material.STICK, "Black", "&0", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(1, createGuiItem(Material.STICK, "Dark Blue", "&1", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(2, createGuiItem(Material.STICK, "Dark Green", "&2", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(3, createGuiItem(Material.STICK, "Dark Turquoise", "&3", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(4, createGuiItem(Material.STICK, "Dark Red", "&4", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(5, createGuiItem(Material.STICK, "Purple", "&5", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(6, createGuiItem(Material.STICK, "Orange", "&6", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(7, createGuiItem(Material.STICK, "Light Gray", "&7", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(8, createGuiItem(Material.STICK, "Dark Gray", "&8", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(9, createGuiItem(Material.STICK, "Light Blue", "&9", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(10, createGuiItem(Material.STICK, "Light Green", "&a", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(11, createGuiItem(Material.STICK, "Light Turquoise", "&b", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(12, createGuiItem(Material.STICK, "Red", "&c", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(13, createGuiItem(Material.STICK, "Magenta", "&d", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(14, createGuiItem(Material.STICK, "Yellow", "&e", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(15, createGuiItem(Material.STICK, "White", "&f", ChatColor.RED + "Cannot show color icon"));
			}
		}

		if (pageID.getID() == GUI_PAGE_ID.CMD_SETCHATCOLOR_INPUT_SPECIAL.getID() || pageID.getID() == GUI_PAGE_ID.CMD_SETNAMECOLOR_INPUT_SPECIAL.getID()) {
			try {
				new_gui.setItem(0, BannerItem.addPattern(BannerItem.createEmpty("None", ""), DyeColor.WHITE, PatternType.BASE));
				new_gui.setItem(1, BannerItem.addPattern(BannerItem.addPattern(BannerItem.createEmpty("Bold", "&l"), DyeColor.WHITE, PatternType.BASE), DyeColor.BLACK, PatternType.BORDER));
				new_gui.setItem(2,
						BannerItem
								.addPattern(BannerItem.addPattern(BannerItem.addPattern(BannerItem.addPattern(BannerItem.createEmpty("Underline", "&n"), DyeColor.WHITE, PatternType.BASE), DyeColor.BLACK, PatternType.HALF_HORIZONTAL_MIRROR),
										DyeColor.WHITE, PatternType.STRIPE_BOTTOM), DyeColor.WHITE, PatternType.STRIPE_MIDDLE));
				new_gui.setItem(3, BannerItem.addPattern(BannerItem.addPattern(BannerItem.createEmpty("Itallic", "&o"), DyeColor.WHITE, PatternType.BASE), DyeColor.BLACK, PatternType.STRIPE_DOWNLEFT));
				new_gui.setItem(4,
						BannerItem.addPattern(
								BannerItem.addPattern(BannerItem.addPattern(BannerItem.addPattern(BannerItem.addPattern(BannerItem.createEmpty("Magic", "&k"), DyeColor.WHITE, PatternType.BASE), DyeColor.BLACK, PatternType.STRIPE_DOWNLEFT),
										DyeColor.BLACK, PatternType.TRIANGLE_BOTTOM), DyeColor.BLACK, PatternType.TRIANGLE_TOP),
								DyeColor.BLACK, PatternType.CIRCLE_MIDDLE));
				new_gui.setItem(5, BannerItem.addPattern(BannerItem.addPattern(BannerItem.createEmpty("Strike", "&m"), DyeColor.WHITE, PatternType.BASE), DyeColor.BLACK, PatternType.STRIPE_MIDDLE));
			} catch (NoSuchFieldError e) {
				new_gui.setItem(0, createGuiItem(Material.STICK, "None", "", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(1, createGuiItem(Material.STICK, "Bold", "&l", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(2, createGuiItem(Material.STICK, "Underline", "&n", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(3, createGuiItem(Material.STICK, "Itallic", "&o", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(4, createGuiItem(Material.STICK, "Magic", "&k", ChatColor.RED + "Cannot show color icon"));
				new_gui.setItem(5, createGuiItem(Material.STICK, "Strike", "&m", ChatColor.RED + "Cannot show color icon"));
			}
		}
