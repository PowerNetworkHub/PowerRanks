...
public class ConfigFilesUpdater {
	...
	public static void updateConfigFiles(PowerRanks plugin, StorageType storageType) {
		...
		boolean updateRanksYAML = storageType == StorageType.YAML ? checkVersion(PowerRanks.fileLoc, "Ranks.yml", plugin) : false;
		boolean updatePlayersYAML = storageType == StorageType.YAML ? checkVersion(PowerRanks.fileLoc, "Players.yml", plugin) : false;
